    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator(message='Use Valid symbols for username.', regex='^[\\w.@+-]+\\Z')], verbose_name='User Name')),
